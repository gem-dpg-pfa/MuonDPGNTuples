...
options.register('globalTag',
                 '140X_dataRun3_Prompt_v2', #'124X_dataRun3_Prompt_v4',
...
if "eos/cms" in options.inputFolder:
    ...
    process.source.fileNames = ["file:/eos/cms/tier0/store/data/Run2024D/RPCMonitor/RAW/v1/000/380/538/00000/ef6ae55a-753d-48de-8839-407b3e672867.root"]
...
process.PoolDBESSourceGeometry = cms.ESSource("PoolDBESSource",
                                              toGet = cms.VPSet(
                                                  cms.PSet(
                                                      ...
                                                      tag = cms.string('GEMRECO_Geometry_141DD4hepV4')
                                                  )),
